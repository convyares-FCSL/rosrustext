...
impl LifecycleNode {
    ...
    pub(crate) fn handle_get_available_states(
        ...
        use rclrust_core::lifecycle::State as CoreState;

        // Full set of lifecycle states (primary + transition states).
        // This matches ROS2 lifecycle semantics: these are the states a lifecycle node can report.
        let all = [
...
mod tests {
    ...
    fn get_state_reports_current_state() {
        ...
        assert_eq!(
            resp.state_id,
            rclrust_core::lifecycle::State::Unconfigured.id()
        );
    ...
    fn get_available_states_reports_all_states() {
        ...
        // Sanity: includes primary states
