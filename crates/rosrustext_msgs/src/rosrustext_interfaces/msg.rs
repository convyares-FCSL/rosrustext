...
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__rosrustext_interfaces__msg__Status() -> *const std::ffi::c_void;
}

#[link(name = "rosrustext_interfaces__rosidl_generator_c")]
extern "C" {
    fn rosrustext_interfaces__msg__Status__init(msg: *mut Status) -> bool;
    fn rosrustext_interfaces__msg__Status__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<Status>, size: usize) -> bool;
    fn rosrustext_interfaces__msg__Status__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<Status>);
    fn rosrustext_interfaces__msg__Status__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<Status>, out_seq: *mut rosidl_runtime_rs::Sequence<Status>) -> bool;
}
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: crate::std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Owned(msg.header)).into_owned(),
      ...
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: crate::std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        id: msg.id.as_str().into(),
        instance_id: msg.instance_id.as_str().into(),
      active: msg.active,
      heartbeat_timeout: msg.heartbeat_timeout,
