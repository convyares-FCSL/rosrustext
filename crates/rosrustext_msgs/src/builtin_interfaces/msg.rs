pub mod rmw {
    ...
    extern "C" {
        ...
        fn builtin_interfaces__msg__Duration__Sequence__init(
            seq: *mut rosidl_runtime_rs::Sequence<Duration>, size: usize,
        ) -> bool;
        ...
        fn builtin_interfaces__msg__Duration__Sequence__copy(
            in_seq: &rosidl_runtime_rs::Sequence<Duration>, out_seq: *mut rosidl_runtime_rs::Sequence<Duration>,
        ) -> bool;
    }
    ...
    extern "C" {
        ...
        fn builtin_interfaces__msg__Time__Sequence__init(
            seq: *mut rosidl_runtime_rs::Sequence<Time>, size: usize,
        ) -> bool;
        ...
        fn builtin_interfaces__msg__Time__Sequence__copy(
            in_seq: &rosidl_runtime_rs::Sequence<Time>, out_seq: *mut rosidl_runtime_rs::Sequence<Time>,
        ) -> bool;
    }
...
impl Default for Duration {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::builtin_interfaces::msg::rmw::Duration::default())
    }
}

impl rosidl_runtime_rs::Message for Duration {
    type RmwMsg = crate::builtin_interfaces::msg::rmw::Duration;

    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => {
                std::borrow::Cow::Owned(Self::RmwMsg { sec: msg.sec, nanosec: msg.nanosec })
            }
    ...
    fn from_rmw_message(msg: Self::RmwMsg) -> Self {
        Self { sec: msg.sec, nanosec: msg.nanosec }
    }
}
...
impl Default for Time {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::builtin_interfaces::msg::rmw::Time::default())
    }
}

impl rosidl_runtime_rs::Message for Time {
    type RmwMsg = crate::builtin_interfaces::msg::rmw::Time;
