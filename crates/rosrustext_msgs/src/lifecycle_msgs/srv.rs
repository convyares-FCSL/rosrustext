...
impl Default for ChangeState_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::ChangeState_Request::default())
  }
}
...
impl Default for ChangeState_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::ChangeState_Response::default())
  }
}
...
impl Default for GetAvailableStates_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetAvailableStates_Request::default())
  }
}
...
impl Default for GetAvailableStates_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetAvailableStates_Response::default())
  }
}
    ...
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        available_states: msg.available_states
          .into_iter()
          .map(|elem| crate::lifecycle_msgs::msg::State::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        available_states: msg.available_states
          .iter()
          .map(|elem| crate::lifecycle_msgs::msg::State::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
...
impl Default for GetAvailableTransitions_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetAvailableTransitions_Request::default())
  }
}
...
impl Default for GetAvailableTransitions_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetAvailableTransitions_Response::default())
  }
}
    ...
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        available_transitions: msg.available_transitions
          .into_iter()
          .map(|elem| crate::lifecycle_msgs::msg::TransitionDescription::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        available_transitions: msg.available_transitions
          .iter()
          .map(|elem| crate::lifecycle_msgs::msg::TransitionDescription::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
...
impl Default for GetState_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetState_Request::default())
  }
}
...
impl Default for GetState_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::lifecycle_msgs::srv::rmw::GetState_Response::default())
  }
}
...
impl rosidl_runtime_rs::Message for GetState_Response {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        current_state: crate::lifecycle_msgs::msg::State::into_rmw_message(std::borrow::Cow::Owned(msg.current_state)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        current_state: crate::lifecycle_msgs::msg::State::into_rmw_message(std::borrow::Cow::Borrowed(&msg.current_state)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      current_state: crate::lifecycle_msgs::msg::State::from_rmw_message(msg.current_state),
    }
  }
}
